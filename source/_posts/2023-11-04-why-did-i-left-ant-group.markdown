...
记得某天工作整整满一年时，命运的齿轮开始转动。晚上收到来自蚂蚁的一份邮件（称博客吸引，可以帮忙内推），便顺水推舟进入面试，并最终加入蚂蚁，成为了一名业务 SRE（[Site Reliability Engineer](/blog/20180403/impressions-of-google-sre/)）。主要参与国际支付业务线上稳定性保障（AliExpress/天猫国际/Apple代扣/Lazada/...），通过软件工程等实践在监控告警领域持续探索。
...
high performance 与晋升，对应经济收入的指数型增长。可能难以想象，相比第一份工作，年收入增长接近十倍～
...
但更进一步，面向未来，如何避免其他系统，以及持续的代码改动再次引入该问题呢？除了通过日志 tracing 的关联和离线清洗产出 T+1 的报表进行预警，还可以通过定期的自动化线上回归演练，来尽早规避该问题。
